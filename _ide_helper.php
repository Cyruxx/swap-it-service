...
namespace {
    ...
    class Route extends \Illuminate\Support\Facades\Route{
		 ...
		 * @static 
		 */
        public static function __construct($events, $properties, $container = null){
            \Dingo\Api\Routing\Router::__construct($events, $properties, $container);
        }
    ...
    class URL extends \Illuminate\Support\Facades\URL{
        ...
        public static function __construct($routes, $request){
            \Dingo\Api\Routing\UrlGenerator::__construct($routes, $request);
        }
    ...
    class API extends \Dingo\Api\Facade\API{
		 ...
		 * @static 
		 */
        public static function __construct($container, $files, $url, $router, $auth, $properties){
            \Dingo\Api\Dispatcher::__construct($container, $files, $url, $router, $auth, $properties);
        }
    ...
    class SentrySocial extends \Cartalyst\SentrySocial\Facades\Laravel\SentrySocial{
        
        /**
		 * Create a new Sentry Social manager.
		 *
		 * @param \Cartalyst\SentrySocial\Cartalyst\SentrySocial\SocialLinks\ProviderInterface $socialLinkProvider
		 * @param \Cartalyst\SentrySocial\Cartalyst\Sentry\ServiceFactory $serviceFactory
		 * @param array $connections
		 * @param \Cartalyst\SentrySocial\Illuminate\Events\Dispatcher
		 * @return void 
		 * @static 
		 */
        public static function __construct($sentry, $socialLinkProvider = null, $serviceFactory = null, $connections = array(), $dispatcher = null){
            \Cartalyst\SentrySocial\Manager::__construct($sentry, $socialLinkProvider, $serviceFactory, $connections, $dispatcher);
        }
		 ...
		 * @param string $slug
		 * @param array $attributes
		 * @return \Cartalyst\SentrySocial\Cartalyst\SentrySocial\Connection $connection
		 * @static 
		 */
        public static function register($slug, $attributes){
            return \Cartalyst\SentrySocial\Manager::register($slug, $attributes);
        }
		 ...
		 * @static 
		 */
        public static function registerOAuth2Service($className){
            \Cartalyst\SentrySocial\Manager::registerOAuth2Service($className);
        }
		 ...
		 * @static 
		 */
        public static function registerOAuth1Service($className){
            \Cartalyst\SentrySocial\Manager::registerOAuth1Service($className);
        }
		 ...
		 * @return \Cartalyst\SentrySocial\Cartalyst\SentrySocial\Services\ServiceInterface 
		 * @static 
		 */
        public static function make($slug, $callback = null){
            return \Cartalyst\SentrySocial\Manager::make($slug, $callback);
        }
		 ...
		 * @static 
		 */
        public static function requestAccessToken($service, $access){
            return \Cartalyst\SentrySocial\Manager::requestAccessToken($service, $access);
        }
		 ...
		 * @static 
		 */
        public static function linkUser($service){
            return \Cartalyst\SentrySocial\Manager::linkUser($service);
        }
        ...
        public static function login($user, $remember){
            return \Cartalyst\SentrySocial\Manager::login($user, $remember);
        }
        
        /**
		 * Authenticates the given Sentry Social OAuth service.
		 *
		 * @param \Cartalyst\SentrySocial\Cartalyst\SentrySocial\Services\ServiceInterface $service
		 * @param string $access
		 * @param bool $remember
		 * @return \Cartalyst\SentrySocial\Cartalyst\Sentry\Users\UserInterface $user
		 * @todo Add a "email_changed_from_social" field to `users` and update
		 *         email address if different when authenticating??
		 * @static 
		 */
        public static function authenticate($service, $access, $remember = false){
            return \Cartalyst\SentrySocial\Manager::authenticate($service, $access, $remember);
        }
		 ...
		 */
        public static function getConnections(){
            return \Cartalyst\SentrySocial\Manager::getConnections();
        }
		 ...
		 */
        public static function setDispatcher($dispatcher){
            \Cartalyst\SentrySocial\Manager::setDispatcher($dispatcher);
        }
